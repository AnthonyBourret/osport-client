...
function Menu() {
  return (
    <nav className="flex w-full justify-left py-0 fixed bottom-0 bg-neutral-focus border-t-4 border-base-100
    sm:relative sm:-top-16 sm:w-fit sm:m-auto sm:border-none sm:bg-opacity-0 z-10 overflow-x-scroll"
    >
      <Link to="/"><button type="button" className="btn btn-ghost text-sm sm:btn-xl sm:text-lg px-3">Profile</button></Link>
      ...
      <div className="dropdown dropdown-hover">
        <button
          type="button"
          className="btn btn-ghost text-sm sm:btn-xl sm:text-lg px-3"
        >
          Legal
        </button>
